      ...
      <div className="space-y-3">
        ...
        >
          <div className={`p-2 rounded-lg flex-shrink-0 ${
            value === 'small' ? 'bg-accent-100' : 'bg-slate-100'
          }`}>
            <Building className={`w-5 h-5 ${
              value === 'small' ? 'text-accent-600' : 'text-slate-600'
            }`} />
          </div>
          <div className="flex-1 text-left">
            <div className={`${
              value === 'small' ? 'text-accent-900' : 'text-slate-900'
            }`}>
              Small Company
            </div>
        ...
        >
          <div className={`p-2 rounded-lg flex-shrink-0 ${
            value === 'medium' ? 'bg-accent-100' : 'bg-slate-100'
          }`}>
            <Building2 className={`w-5 h-5 ${
              value === 'medium' ? 'text-accent-600' : 'text-slate-600'
            }`} />
          </div>
          <div className="flex-1 text-left">
            <div className={`${
              value === 'medium' ? 'text-accent-900' : 'text-slate-900'
            }`}>
              Medium Company
            </div>
            <div className="text-sm text-slate-600 mt-1">
        ...
        >
          <div className={`p-2 rounded-lg flex-shrink-0 ${
            value === 'large' ? 'bg-accent-100' : 'bg-slate-100'
          }`}>
            <TrendingUp className={`w-5 h-5 ${
              value === 'large' ? 'text-accent-600' : 'text-slate-600'
            }`} />
          </div>
          <div className="flex-1 text-left">
            <div className={`${
              value === 'large' ? 'text-accent-900' : 'text-slate-900'
            }`}>
              Large Company
            </div>
            <div className="text-sm text-slate-600 mt-1">
